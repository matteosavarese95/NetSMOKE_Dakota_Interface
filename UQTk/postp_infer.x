...
$IUQ/get_postpred.py -p qtrain.dat -f ytrain_surr.dat -n 6 

## Posterior predictive samples of surrogate
$IUQ/get_postpred.py -p post_phparam.dat -f post_pred.dat -n 6

## Plot posterior PDFs of select outputs
# example of 0th, 1st and 5th outputs
$IUQ/plot_pdfs.py 0 1 2 3 4 5 -p post_pred.dat -n outnames.txt -t tri

## Plot prior and posterior together with data
$IUQ/plot_prpost.py 0 1 2 3 4 5 -y ytrain_surr.dat -z post_pred.dat -d ydata_all.txt -n outnames.txt
...
awk '$2<801{print NR-1}' xdata_all.txt > ind_plot.dat
awk '$2<801{print $3}' xydata_all.txt > ydata_plot.dat
