...
printf "0\n1" > de_params.dat # embedding in the first two parameters
...
#${UQBIN}/model_inf -l abc -w 0.5 -r de_params.dat -o $PCORD -i uniform_LUpci -t xdata_all.txt -f $PMTYPE -c LU -s pci -d $DIM -z -x xdata_calib.txt -y ydata_calib.txt -e $EE  -m $NMCMC -g $GAMMA -u 5 -a -1 -b 1 #-j chainstart.dat
